      ...
      <a-layout-header>
        <div>
          <a-row>
            ...
            <a-col :span="10">
              <a-select default-value="選擇PTT看版" style="width: 100%" @change="selectBoard">
                <a-select-option v-for="(board, index) in pttBoard" :key="index" :value="board">
                  {{board}}
                </a-select-option>
              </a-select>
            </a-col>
...
export default {
  ...
  data () {
    return {
      selBoard: '',
      pttBoard: ['Marvel', 'Stock'],
      boardArticle: {
        Marvel: [
          { title: 'MT1', id: 't1', link: '/T1', comment: 100 },
